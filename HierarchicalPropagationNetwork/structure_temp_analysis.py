...
'''
Restituisce il nodo con la cascata più profonda e l'altezza di tale cascata all'interno di un grafo di tweet.
'''
...
'''
Restituisce il numero di cascata di un nodo di tweet, con il tipo di bordo specificato (ad esempio, "retweet" o "reply").
'''
...
'''
Restituisce il numero di cascata di un nodo di tweet entro un certo intervallo temporale.
'''
...
'''
Restituisce il numero di nodi nella cascata più profonda all'interno di un grafo di tweet.
'''
...
'''
Restituisce il massimo outdegree (numero di figli diretti) di un nodo di tweet.
'''
...
'''
Restituisce il nodo con il massimo outdegree e il suo outdegree all'interno di un grafo di tweet.
'''
...
'''
Restituisce il livello del nodo di destinazione all'interno di un grafo delle interazioni.
'''
...
'''
Restituisce la profondità del nodo con il massimo out-degree in un grafo delle interazioni.
'''
...
'''
Restituisce l'altezza di un albero radicato nel nodo fornito, con il tipo di bordo specificato.
'''
...
'''
Restituisce il numero totale di nodi nell'albero radicato nel nodo fornito, con il tipo di arco specificato.
'''
...
'''
Restituisce il numero di nodi in un albero di tweet entro un certo intervallo temporale.
'''
...
'''
Restituisce la dimensione dell'albero di tweet in funzione del tempo.
'''
...
'''
Restituisce l'altezza dell'albero rispetto al tempo con il tipo di arco specificato.
'''
...
'''
Restituisce il numero di cascate rispetto al tempo con il tipo di arco specificato.
'''
...
'''
Funzioni (analyze_height, analyze_max_outdegree, analyze_cascade, analyze_node_count) per analizzare l'altezza, il 
massimo out-degree, le cascate e il conteggio dei nodi in un grafo delle interazioni.
'''
...
'''
Funzioni (analyze_height_by_time, analyze_cascade_num_by_time, analyze_node_size_by_time) per analizzare l'altezza, il 
numero di cascate e la dimensione del nodo rispetto al tempo.
'''
...
'''
Restituiscono (get_num_of_cascades_with_retweets, get_fraction_of_cascades_with_retweets, 
get_num_of_cascades_with_replies, get_fraction_of_cascades_with_replies) il numero e la frazione di cascate con 
retweet/replies.
'''
...
'''
Funzioni (get_users_in_network, get_users_replying_in_prop_graph, get_users_retweeting_in_prop_graph, 
get_user_names_retweeting_in_prop_graph) per ottenere gli utenti coinvolti in una rete e le loro azioni.
'''
...
'''
Restituiscono (get_num_user_retweet_and_reply, get_ratio_of_retweet_to_reply) il numero di utenti che hanno fatto sia 
retweet che risposte e il rapporto retweet/
'''
...
'''
Restituiscono (get_breadth_at_each_level, get_prop_graphs_max_breadth) la larghezza di ciascun livello e la larghezza 
massima di un grafo delle interazioni.
'''
...
'''
Restituiscono (get_prop_graphs_num_unique_users, get_prop_graphs_fraction_of_unique_users) il numero e la frazione di 
utenti unici in un grafo delle interazioni.
'''
...
'''
Restituiscono (get_prop_graphs_min_time_to_reach_level_1, get_prop_graphs_min_time_to_reach_level_2) il tempo minimo per 
raggiungere il livello 1 e il livello 2 di un grafo delle interazioni.
'''
