...
'''
Calcola il tempo medio tra retweet nella cascata più profonda.
'''
...
'''
Calcola la differenza di tempo tra il primo post e l'ultimo retweet nella cascata più profonda.
'''
...
'''
Calcola il tempo medio tra nodi di risposta adiacenti.
'''
...
'''
Calcola il tempo medio tra nodi di retweet adiacenti.
'''
...
'''
Genera informazioni statistiche per una determinata caratteristica su una lista di grafi.
'''
...
'''
Calcola varie caratteristiche temporali per una lista di grafi, inclusi sia micro che macro caratteristiche.
'''
...
'''
Una classe che aiuta a organizzare e recuperare caratteristiche temporali, sia micro che macro, insieme ai loro nomi e 
nomi abbreviati.
'''
