'''
INIT ARCHIVES. Serve a creare due files csv facendo lo scraping da 'politifact.com'. Inserendo una parola chiave, il file csv che viene
...
PS. se si vuole tornare più indietro nel tempo, usare un n maggiore (alla linea 195)
